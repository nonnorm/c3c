...
#define USER_DEFINED_TYPES (EXPORTED_USER_DEFINED_TYPES | ATTR_BITSTRUCT | ATTR_TYPEDEF)
...
typedef enum
{
	...
	INTROSPECT_TYPE_UNTYPEDLIST = 21,
} IntrospectType;
...
typedef enum
{
	...
	TYPE_MEMBER,
	TYPE_REFLECTION,
	TYPE_LAST = TYPE_REFLECTION
} TypeKind;

typedef enum
{
	TYPE_PROPERTY_ALIGNMENT,
	TYPE_PROPERTY_FROM_ORDINAL,
	TYPE_PROPERTY_HAS_EQUALS,
	...
	TYPE_PROPERTY_MAX,
	TYPE_PROPERTY_MIN,
	TYPE_PROPERTY_MEMBERS,
	TYPE_PROPERTY_METHODS,
	TYPE_PROPERTY_NAN,
	TYPE_PROPERTY_INF,
	TYPE_PROPERTY_INNER,
	TYPE_PROPERTY_KIND,
	...
	TYPE_PROPERTY_SIZE,
	TYPE_PROPERTY_GET_TAG,
	TYPE_PROPERTY_HAS_TAG,
	TYPE_PROPERTY_TAGS,
...
typedef enum
{
	...
	WASM_FEAT_SIGN_EXT,
	WASM_FEAT_ATOMICS,
	WASM_FEATURE_LAST = WASM_FEAT_ATOMICS,
} WasmFeature;
...
#define ARCH_UNSUPPORTED ARCH_TYPE_AARCH64_32: case ARCH_TYPE_BPFEL: case ARCH_TYPE_BPFEB: case ARCH_TYPE_SPARCEL: \
 ...
 case ARCH_TYPE_NVPTX64: case ARCH_TYPE_NVPTX: case ARCH_TYPE_MSP430: case ARCH_TYPE_SYSTEMZ:  \
...
#define NON_RUNTIME_EXPR EXPR_POISONED: \
		...
		case EXPR_TYPEINFO: case EXPR_HASH_IDENT: \
		case EXPR_COMPILER_CONST: case EXPR_CT_FEATURE: case EXPR_CONTRACT: \
		case EXPR_SPLAT: case EXPR_STRINGIFY: case EXPR_TYPECALL: \
		case EXPR_CT_EVAL: case EXPR_MAYBE_DEREF: case EXPR_CT_REFLECT
...
#define OS_UNSUPPORTED OS_TYPE_AIX: case OS_TYPE_HAIKU: case OS_TYPE_ANANAS: case OS_TYPE_CLOUD_ABI: \
 ...
 case OS_TYPE_CONTIKI: case OS_TYPE_AMDPAL: case OS_TYPE_HERMITCORE: case OS_TYPE_HURD
...
#define NON_VOID_TYPE_TOKENS \
  ...
  case TOKEN_UPTR: case TOKEN_USHORT: case TOKEN_USZ: case TOKEN_UNTYPEDLIST: \
...
// -- Types helper macros
#define FLATTENED_TYPES TYPE_TYPEDEF: case TYPE_OPTIONAL: case TYPE_ALIAS
...
#define ALL_VECTORS TYPE_VECTOR: case TYPE_INFERRED_VECTOR: case TYPE_SIMD_VECTOR
#define ALL_ARRAYLIKE TYPE_VECTOR: case TYPE_INFERRED_VECTOR: case TYPE_SIMD_VECTOR: case TYPE_ARRAY: case TYPE_INFERRED_ARRAY: case TYPE_FLEXIBLE_ARRAY
#define VECTORS TYPE_VECTOR: case TYPE_SIMD_VECTOR
...
#define SPECIAL_TYPES TYPE_TYPEINFO: case TYPE_MEMBER: case TYPE_REFLECTION

#define CT_TYPES TYPE_TYPEINFO: case TYPE_INFERRED_ARRAY: case TYPE_INFERRED_VECTOR: \
case TYPE_POISONED: case TYPE_MEMBER: case TYPE_WILDCARD: case TYPE_REFLECTION
...
#define UNRESOLVED_EXPRS EXPR_TRY_UNRESOLVED: case EXPR_ACCESS_UNRESOLVED: \
	...
	case EXPR_VACOUNT: case EXPR_VAARG: \
	case EXPR_IOTA_DECL: case EXPR_LENGTHOF: case EXPR_CT_IDENT: case EXPR_TYPE_PROPERTY: \
